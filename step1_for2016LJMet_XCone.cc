...
void step1::Loop() 
{
  ...
  // ----------------------------------------------------------------------------
   ...
   //XCone
   inputTree->SetBranchStatus("XConeNumJets_optimal_XConeCalc",1);
   inputTree->SetBranchStatus("XConeNumJets_optimal_puppi_XConeCalc",1);
   inputTree->SetBranchStatus("eventRho_XConeCalc",1);
   inputTree->SetBranchStatus("tau_njettiness_XConeCalc",1);
   inputTree->SetBranchStatus("tau_njettiness_puppi_XConeCalc",1);
   inputTree->SetBranchStatus("tau_njettiness_diff_XConeCalc",1);
   inputTree->SetBranchStatus("tau_njettiness_diff_puppi_XConeCalc",1);
   inputTree->SetBranchStatus("tau_njettiness_div_XConeCalc",1);
   inputTree->SetBranchStatus("tau_njettiness_div_puppi_XConeCalc",1);
   inputTree->SetBranchStatus("tau_njettiness_diffdivComb_XConeCalc",1);
   inputTree->SetBranchStatus("tau_njettiness_diffdivComb_puppi_XConeCalc",1);
   inputTree->SetBranchStatus("XConeNumJets_optimal_XConeCalc",1);
   inputTree->SetBranchStatus("XConeNumJets_optimal_puppi_XConeCalc",1);
   inputTree->SetBranchStatus("eventRho_XConeCalc",1);
   inputTree->SetBranchStatus("RawXConeJetPt_XConeCalc",1);
   inputTree->SetBranchStatus("RawXConeJetEta_XConeCalc",1);
   inputTree->SetBranchStatus("RawXConeJetPhi_XConeCalc",1);
   inputTree->SetBranchStatus("RawXConeJetEnergy_XConeCalc",1);
   inputTree->SetBranchStatus("RawXConeJetArea_XConeCalc",1);
   inputTree->SetBranchStatus("theXConeJetPt_XConeCalc",1);
   inputTree->SetBranchStatus("theXConeJetEta_XConeCalc",1);
   inputTree->SetBranchStatus("theXConeJetPhi_XConeCalc",1);
   inputTree->SetBranchStatus("theXConeJetEnergy_XConeCalc",1);
   inputTree->SetBranchStatus("theXConeJetArea_XConeCalc",1);
   inputTree->SetBranchStatus("theXConePUPPIJetPt_XConeCalc",1);
   inputTree->SetBranchStatus("theXConePUPPIJetEta_XConeCalc",1);
   inputTree->SetBranchStatus("theXConePUPPIJetPhi_XConeCalc",1);
   inputTree->SetBranchStatus("theXConePUPPIJetEnergy_XConeCalc",1);
   inputTree->SetBranchStatus("theXConePUPPIJetArea_XConeCalc",1);
  ...
  // ----------------------------------------------------------------------------
   ...
   //XCone
   outputTree->Branch("XConeNumJets_optimal_XConeCalc",&XConeNumJets_optimal_XConeCalc,"XConeNumJets_optimal_XConeCalc/I");
   outputTree->Branch("XConeNumJets_optimal_puppi_XConeCalc",&XConeNumJets_optimal_puppi_XConeCalc,"XConeNumJets_optimal_puppi_XConeCalc/I");
   outputTree->Branch("eventRho_XConeCalc",&eventRho_XConeCalc,"eventRho_XConeCalc/F");
   outputTree->Branch("tau_njettiness_XConeCalc",&tau_njettiness_XConeCalc);
   outputTree->Branch("tau_njettiness_puppi_XConeCalc",&tau_njettiness_puppi_XConeCalc);
   outputTree->Branch("tau_njettiness_diff_XConeCalc",&tau_njettiness_diff_XConeCalc);
   outputTree->Branch("tau_njettiness_diff_puppi_XConeCalc",&tau_njettiness_diff_puppi_XConeCalc);
   outputTree->Branch("tau_njettiness_div_XConeCalc",&tau_njettiness_div_XConeCalc);
   outputTree->Branch("tau_njettiness_div_puppi_XConeCalc",&tau_njettiness_div_puppi_XConeCalc);
   outputTree->Branch("tau_njettiness_diffdivComb_XConeCalc",&tau_njettiness_diffdivComb_XConeCalc);
   outputTree->Branch("tau_njettiness_diffdivComb_puppi_XConeCalc",&tau_njettiness_diffdivComb_puppi_XConeCalc);
   outputTree->Branch("XConeNumJets_optimal_XConeCalc",&XConeNumJets_optimal_XConeCalc);
   outputTree->Branch("XConeNumJets_optimal_puppi_XConeCalc",&XConeNumJets_optimal_puppi_XConeCalc);
   outputTree->Branch("eventRho_XConeCalc",&eventRho_XConeCalc);
   outputTree->Branch("RawXConeJetPt_XConeCalc",&RawXConeJetPt_XConeCalc);
   outputTree->Branch("RawXConeJetEta_XConeCalc",&RawXConeJetEta_XConeCalc);
   outputTree->Branch("RawXConeJetPhi_XConeCalc",&RawXConeJetPhi_XConeCalc);
   outputTree->Branch("RawXConeJetEnergy_XConeCalc",&RawXConeJetEnergy_XConeCalc);
   outputTree->Branch("RawXConeJetArea_XConeCalc",&RawXConeJetArea_XConeCalc);
   outputTree->Branch("theXConeJetPt_XConeCalc",&theXConeJetPt_XConeCalc);
   outputTree->Branch("theXConeJetEta_XConeCalc",&theXConeJetEta_XConeCalc);
   outputTree->Branch("theXConeJetPhi_XConeCalc",&theXConeJetPhi_XConeCalc);
   outputTree->Branch("theXConeJetEnergy_XConeCalc",&theXConeJetEnergy_XConeCalc);
   outputTree->Branch("theXConeJetArea_XConeCalc",&theXConeJetArea_XConeCalc);
   outputTree->Branch("theXConePUPPIJetPt_XConeCalc",&theXConePUPPIJetPt_XConeCalc);
   outputTree->Branch("theXConePUPPIJetEta_XConeCalc",&theXConePUPPIJetEta_XConeCalc);
   outputTree->Branch("theXConePUPPIJetPhi_XConeCalc",&theXConePUPPIJetPhi_XConeCalc);
   outputTree->Branch("theXConePUPPIJetEnergy_XConeCalc",&theXConePUPPIJetEnergy_XConeCalc);
   outputTree->Branch("theXConePUPPIJetArea_XConeCalc",&theXConePUPPIJetArea_XConeCalc);

   outputTree->Branch("theXConeJetPt_XConeCalc_PtOrdered",&theXConeJetPt_XConeCalc_PtOrdered);
   outputTree->Branch("theXConeJetEta_XConeCalc_PtOrdered",&theXConeJetEta_XConeCalc_PtOrdered);
   ...
   outputTree->Branch("theXConePUPPIJetEnergy_XConeCalc_PtOrdered",&theXConePUPPIJetEnergy_XConeCalc_PtOrdered);
   outputTree->Branch("theXConePUPPIJetArea_XConeCalc_PtOrdered",&theXConePUPPIJetArea_XConeCalc_PtOrdered);
   
   outputTree->Branch("NXConeJets",&NXConeJets,"NXConeJets/I");
   outputTree->Branch("XConeHT",&XConeHT,"XConeHT/D");
   outputTree->Branch("NXConePUPPIJets",&NXConePUPPIJets,"NXConePUPPIJets/I");
   outputTree->Branch("XConePUPPIHT",&XConePUPPIHT,"XConePUPPIHT/D");
   
   //taken from Julie's step2: /user_data/jhogan/CMSSW_7_4_14/src/step2_slim80X.cc - start
   double TrigEffWeightRMA, TrigEffWeightRMAUncert;
  ...
  // ----------------------------------------------------------------------------
   ...
   float metCut=60;//50;
   int   njetsCut=3;
   float JetLeadPtCut=200;//100;
   float JetSubLeadPtCut=100;//50;
   float lepPtCut=60;//50;
   float elEtaCut=2.5;
   float muEtaCut=2.4;
   float jetEtaCut=2.4;
   float ak8EtaCut=2.4;
   float jetPtCut=50;//30;
   float AK4HTCut=400;
  ...
  // ----------------------------------------------------------------------------
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	MCPastTriggerHTTight = 1;
      ...
      //taken from Julie's step2: /user_data/jhogan/CMSSW_7_4_14/src/step2_slim80X.cc - start
      TrigEffWeightRMA = 1.0;
      TrigEffWeightRMAUncert = 1.0;
      if(isMC){
	if(isElectron){
	  // Ele15_IsoVVVL_PFHT350 || Ele15_IsoVVVL_PFHT400 || Ele32_WPTight_Gsf -- REMINIAOD DATA EFFICIENCIES, Julie - 26Jun2017
	  //RRB2G:
	  double TrigEffWeightR = 1.0;
	  double TrigEffWeightH = 1.0;
	  double TrigEffWeightRUncert = 1.0;
	  double TrigEffWeightHUncert = 1.0;
	  if(leppt < 60){
	    if(fabs(lepeta) < 0.8) {TrigEffWeightR = 0.916; TrigEffWeightRUncert = 0.029;} // 
	    else if(fabs(lepeta) < 1.442) {TrigEffWeightR = 0.923; TrigEffWeightRUncert = 0.036;}
	    else if(fabs(lepeta) < 1.566) {TrigEffWeightR = 1.000; TrigEffWeightRUncert = 0.000;}
	    else if(fabs(lepeta) < 2.0) {TrigEffWeightR = 0.829; TrigEffWeightRUncert = 0.041;}
	    else {TrigEffWeightR = 0.807; TrigEffWeightRUncert = 0.040;}
	  }else if(leppt < 70){
	    if(fabs(lepeta) < 0.8) {TrigEffWeightR = 0.910; TrigEffWeightRUncert = 0.030;} // 
	    else if(fabs(lepeta) < 1.442) {TrigEffWeightR = 0.936; TrigEffWeightRUncert = 0.038;}
	    else if(fabs(lepeta) < 1.566) {TrigEffWeightR = 1.000; TrigEffWeightRUncert = 0.000;}
	    else if(fabs(lepeta) < 2.0) {TrigEffWeightR = 0.845; TrigEffWeightRUncert = 0.045;}
	    else {TrigEffWeightR = 0.851; TrigEffWeightRUncert = 0.046;}
	  }else if(leppt < 100){
	    if(fabs(lepeta) < 0.8) {TrigEffWeightR = 0.930; TrigEffWeightRUncert = 0.019;} // 
	    else if(fabs(lepeta) < 1.442) {TrigEffWeightR = 0.942; TrigEffWeightRUncert = 0.025;}
	    else if(fabs(lepeta) < 1.566) {TrigEffWeightR = 1.000; TrigEffWeightRUncert = 0.000;}
	    else if(fabs(lepeta) < 2.0) {TrigEffWeightR = 0.881; TrigEffWeightRUncert = 0.030;}
	    else {TrigEffWeightR = 0.856; TrigEffWeightRUncert = 0.031;}
	  }else if(leppt < 200){
	    if(fabs(lepeta) < 0.8) {TrigEffWeightR = 0.944; TrigEffWeightRUncert = 0.013;} // 
	    else if(fabs(lepeta) < 1.442) {TrigEffWeightR = 0.950; TrigEffWeightRUncert = 0.017;}
	    else if(fabs(lepeta) < 1.566) {TrigEffWeightR = 1.000; TrigEffWeightRUncert = 0.000;}
	    else if(fabs(lepeta) < 2.0) {TrigEffWeightR = 0.874; TrigEffWeightRUncert = 0.022;}
	    else {TrigEffWeightR = 0.862; TrigEffWeightRUncert = 0.024;}
	  }else{
	    if(fabs(lepeta) < 0.8) {TrigEffWeightR = 0.943; TrigEffWeightRUncert = 0.014;} // 
	    else if(fabs(lepeta) < 1.442) {TrigEffWeightR = 0.944; TrigEffWeightRUncert = 0.019;}
	    else if(fabs(lepeta) < 1.566) {TrigEffWeightR = 1.000; TrigEffWeightRUncert = 0.000;}
	    else if(fabs(lepeta) < 2.0) {TrigEffWeightR = 0.841; TrigEffWeightRUncert = 0.020;}
	    else {TrigEffWeightR = 0.857; TrigEffWeightRUncert = 0.024;}
	  }
	  //PRH:
	  if(leppt < 60){
	    if(fabs(lepeta) < 0.8) {TrigEffWeightH = 0.902; TrigEffWeightHUncert = 0.057;} // 
	    else if(fabs(lepeta) < 1.442) {TrigEffWeightH = 0.937; TrigEffWeightHUncert = 0.072;}
	    else if(fabs(lepeta) < 1.566) {TrigEffWeightH = 1.000; TrigEffWeightHUncert = 0.000;}
	    else if(fabs(lepeta) < 2.0) {TrigEffWeightH = 0.793; TrigEffWeightHUncert = 0.079;}
	    else {TrigEffWeightH = 0.799; TrigEffWeightHUncert = 0.081;}
	  }else if(leppt < 70){
	    if(fabs(lepeta) < 0.8) {TrigEffWeightH = 0.936; TrigEffWeightHUncert = 0.057;} // 
	    else if(fabs(lepeta) < 1.442) {TrigEffWeightH = 0.916; TrigEffWeightHUncert = 0.071;}
	    else if(fabs(lepeta) < 1.566) {TrigEffWeightH = 1.000; TrigEffWeightHUncert = 0.000;}
	    else if(fabs(lepeta) < 2.0) {TrigEffWeightH = 0.837; TrigEffWeightHUncert = 0.087;}
	    else {TrigEffWeightH = 0.767; TrigEffWeightHUncert = 0.081;}
	  }else if(leppt < 100){
	    if(fabs(lepeta) < 0.8) {TrigEffWeightH = 0.938; TrigEffWeightHUncert = 0.037;} // 
	    else if(fabs(lepeta) < 1.442) {TrigEffWeightH = 0.946; TrigEffWeightHUncert = 0.045;}
	    else if(fabs(lepeta) < 1.566) {TrigEffWeightH = 1.000; TrigEffWeightHUncert = 0.000;}
	    else if(fabs(lepeta) < 2.0) {TrigEffWeightH = 0.808; TrigEffWeightHUncert = 0.054;}
	    else {TrigEffWeightH = 0.831; TrigEffWeightHUncert = 0.058;}
	  }else if(leppt < 200){
	    if(fabs(lepeta) < 0.8) {TrigEffWeightH = 0.962; TrigEffWeightHUncert = 0.026;} // 
	    else if(fabs(lepeta) < 1.442) {TrigEffWeightH = 0.951; TrigEffWeightHUncert = 0.033;}
	    else if(fabs(lepeta) < 1.566) {TrigEffWeightH = 1.000; TrigEffWeightHUncert = 0.000;}
	    else if(fabs(lepeta) < 2.0) {TrigEffWeightH = 0.864; TrigEffWeightHUncert = 0.044;}
	    else {TrigEffWeightH = 0.819; TrigEffWeightHUncert = 0.046;}
	  }else{
	    if(fabs(lepeta) < 0.8) {TrigEffWeightH = 0.949; TrigEffWeightHUncert = 0.030;} // 
	    else if(fabs(lepeta) < 1.442) {TrigEffWeightH = 0.945; TrigEffWeightHUncert = 0.041;}
	    else if(fabs(lepeta) < 1.566) {TrigEffWeightH = 1.000; TrigEffWeightHUncert = 0.000;}
	    else if(fabs(lepeta) < 2.0) {TrigEffWeightH = 0.786; TrigEffWeightHUncert = 0.044;}
	    else {TrigEffWeightH = 0.713; TrigEffWeightHUncert = 0.049;}
	  }

	  TrigEffWeightRMA = (27.957*TrigEffWeightR + 8.857*TrigEffWeightH)/36.814;
	  TrigEffWeightRMAUncert = sqrt(pow(27.957*TrigEffWeightRUncert,2) + pow(8.857*TrigEffWeightHUncert,2))/36.814;
	}else{
	  ...
	  double TrigEffWeightHUncert = 1.0;
	  if(leppt < 60){
	    if(fabs(lepeta) < 0.9) {TrigEffWeightR = 0.959; TrigEffWeightRUncert = 0.028;} // 
	    else if(fabs(lepeta) < 1.2) {TrigEffWeightR = 0.973; TrigEffWeightRUncert = 0.052;}
	    else if(fabs(lepeta) < 2.1) {TrigEffWeightR = 0.983; TrigEffWeightRUncert = 0.034;}
	    else {TrigEffWeightR = 0.959; TrigEffWeightRUncert = 0.074;}
	  }else if(leppt < 70){
	    if(fabs(lepeta) < 0.9) {TrigEffWeightR = 0.963; TrigEffWeightRUncert = 0.030;} // 
	    else if(fabs(lepeta) < 1.2) {TrigEffWeightR = 0.978; TrigEffWeightRUncert = 0.055;}
	    else if(fabs(lepeta) < 2.1) {TrigEffWeightR = 0.988; TrigEffWeightRUncert = 0.037;}
	    else {TrigEffWeightR = 0.969; TrigEffWeightRUncert = 0.081;}
	  }else if(leppt < 100){
	    if(fabs(lepeta) < 0.9) {TrigEffWeightR = 0.959; TrigEffWeightRUncert = 0.019;} // 
	    else if(fabs(lepeta) < 1.2) {TrigEffWeightR = 0.975; TrigEffWeightRUncert = 0.036;}
	    else if(fabs(lepeta) < 2.1) {TrigEffWeightR = 0.983; TrigEffWeightRUncert = 0.024;}
	    else {TrigEffWeightR = 0.977; TrigEffWeightRUncert = 0.056;}
	  }else if(leppt < 200){
	    if(fabs(lepeta) < 0.9) {TrigEffWeightR = 0.962; TrigEffWeightRUncert = 0.014;} // 
	    else if(fabs(lepeta) < 1.2) {TrigEffWeightR = 0.976; TrigEffWeightRUncert = 0.027;}
	    else if(fabs(lepeta) < 2.1) {TrigEffWeightR = 0.986; TrigEffWeightRUncert = 0.019;}
	    else {TrigEffWeightR = 0.965; TrigEffWeightRUncert = 0.049;}
	  }else{
	    if(fabs(lepeta) < 0.9) {TrigEffWeightR = 0.949; TrigEffWeightRUncert = 0.019;} // 
	    else if(fabs(lepeta) < 1.2) {TrigEffWeightR = 0.973; TrigEffWeightRUncert = 0.038;}
	    else if(fabs(lepeta) < 2.1) {TrigEffWeightR = 0.986; TrigEffWeightRUncert = 0.030;}
	    else {TrigEffWeightR = 0.964; TrigEffWeightRUncert = 0.099;}
	  }

	  //PRH:
	  if(leppt < 60){
	    if(fabs(lepeta) < 0.9) {TrigEffWeightH = 0.979; TrigEffWeightHUncert = 0.054;} // 
	    else if(fabs(lepeta) < 1.2) {TrigEffWeightH = 0.995; TrigEffWeightHUncert = 0.097;}
	    else if(fabs(lepeta) < 2.1) {TrigEffWeightH = 0.972; TrigEffWeightHUncert = 0.064;}
	    else {TrigEffWeightH = 0.967; TrigEffWeightHUncert = 0.126;}
	  }else if(leppt < 70){
	    if(fabs(lepeta) < 0.9) {TrigEffWeightH = 0.976; TrigEffWeightHUncert = 0.058;} // 
	    else if(fabs(lepeta) < 1.2) {TrigEffWeightH = 0.994; TrigEffWeightHUncert = 0.107;}
	    else if(fabs(lepeta) < 2.1) {TrigEffWeightH = 0.972; TrigEffWeightHUncert = 0.069;}
	    else {TrigEffWeightH = 0.966; TrigEffWeightHUncert = 0.148;}
	  }else if(leppt < 100){
	    if(fabs(lepeta) < 0.9) {TrigEffWeightH = 0.960; TrigEffWeightHUncert = 0.036;} // 
	    else if(fabs(lepeta) < 1.2) {TrigEffWeightH = 0.989; TrigEffWeightHUncert = 0.067;}
	    else if(fabs(lepeta) < 2.1) {TrigEffWeightH = 0.977; TrigEffWeightHUncert = 0.046;}
	    else {TrigEffWeightH = 0.988; TrigEffWeightHUncert = 0.108;}
	  }else if(leppt < 200){
	    if(fabs(lepeta) < 0.9) {TrigEffWeightH = 0.968; TrigEffWeightHUncert = 0.026;} // 
	    else if(fabs(lepeta) < 1.2) {TrigEffWeightH = 0.983; TrigEffWeightHUncert = 0.051;}
	    else if(fabs(lepeta) < 2.1) {TrigEffWeightH = 0.981; TrigEffWeightHUncert = 0.037;}
	    else {TrigEffWeightH = 0.984; TrigEffWeightHUncert = 0.089;}
	  }else{
	    if(fabs(lepeta) < 0.9) {TrigEffWeightH = 0.964; TrigEffWeightHUncert = 0.038;} // 
	    else if(fabs(lepeta) < 1.2) {TrigEffWeightH = 0.988; TrigEffWeightHUncert = 0.075;}
	    else if(fabs(lepeta) < 2.1) {TrigEffWeightH = 0.977; TrigEffWeightHUncert = 0.059;}
	    else {TrigEffWeightH = 0.941; TrigEffWeightHUncert = 0.189;}
	  }
...
*/
	...
	if(isMC){
	  ...
	  */
      ...
      // ----------------------------------------------------------------------------
      // Loop over XCone jets for calculations and pt ordering pair
      // ----------------------------------------------------------------------------

      NXConeJets = 0;
      XConeHT = 0;
      vector<pair<double,int>> xconejetptindpair;
	...
	if(theXConeJetPt_XConeCalc->at(ijet) < jetPtCut || fabs(theXConeJetEta_XConeCalc->at(ijet)) > jetEtaCut) continue;
	...
	if(isMC){
	  ...
	  xconejetptindpair.push_back(std::make_pair(theXConeJetPt_XConeCalc->at(ijet),ijet));
	  NXConeJets+=1;
	  XConeHT+=theXConeJetPt_XConeCalc->at(ijet);
      ...
      // ----------------------------------------------------------------------------
      // Apply pt ordering to XCone vectors
      // ----------------------------------------------------------------------------

      std::sort(xconejetptindpair.begin(), xconejetptindpair.end(), comparepair);
      theXConeJetPt_XConeCalc_PtOrdered.clear();
      theXConeJetEta_XConeCalc_PtOrdered.clear();
      theXConeJetPhi_XConeCalc_PtOrdered.clear();
      theXConeJetEnergy_XConeCalc_PtOrdered.clear();
      for(unsigned int ijet=0; ijet < xconejetptindpair.size(); ijet++){
      	theXConeJetPt_XConeCalc_PtOrdered.push_back(theXConeJetPt_XConeCalc->at(xconejetptindpair[ijet].second));
      	theXConeJetEta_XConeCalc_PtOrdered.push_back(theXConeJetEta_XConeCalc->at(xconejetptindpair[ijet].second));
      	theXConeJetPhi_XConeCalc_PtOrdered.push_back(theXConeJetPhi_XConeCalc->at(xconejetptindpair[ijet].second));
      	theXConeJetEnergy_XConeCalc_PtOrdered.push_back(theXConeJetEnergy_XConeCalc->at(xconejetptindpair[ijet].second));
      }
      ...
      NXConePUPPIJets = 0;
      XConePUPPIHT = 0;
      vector<pair<double,int>> xconepuppijetptindpair;

      for(unsigned int ijet=0; ijet < theXConePUPPIJetPt_XConeCalc->size(); ijet++){

	// ----------------------------------------------------------------------------
	// Basic cuts
	// ----------------------------------------------------------------------------

	if(theXConePUPPIJetPt_XConeCalc->at(ijet) < jetPtCut || fabs(theXConePUPPIJetEta_XConeCalc->at(ijet)) > jetEtaCut) continue;
	...
	if(isMC){
	  ...
	  xconepuppijetptindpair.push_back(std::make_pair(theXConePUPPIJetPt_XConeCalc->at(ijet),ijet));
	  NXConePUPPIJets+=1;
	  XConePUPPIHT+=theXConePUPPIJetPt_XConeCalc->at(ijet);
      ...
      // ----------------------------------------------------------------------------
      // Apply pt ordering to XConePUPPI vectors
      // ----------------------------------------------------------------------------

      std::sort(xconepuppijetptindpair.begin(), xconepuppijetptindpair.end(), comparepair);
      theXConePUPPIJetPt_XConeCalc_PtOrdered.clear();
      theXConePUPPIJetEta_XConeCalc_PtOrdered.clear();
      theXConePUPPIJetPhi_XConeCalc_PtOrdered.clear();
      theXConePUPPIJetEnergy_XConeCalc_PtOrdered.clear();
      for(unsigned int ijet=0; ijet < xconepuppijetptindpair.size(); ijet++){
      	theXConePUPPIJetPt_XConeCalc_PtOrdered.push_back(theXConePUPPIJetPt_XConeCalc->at(xconepuppijetptindpair[ijet].second));
      	theXConePUPPIJetEta_XConeCalc_PtOrdered.push_back(theXConePUPPIJetEta_XConeCalc->at(xconepuppijetptindpair[ijet].second));
      	theXConePUPPIJetPhi_XConeCalc_PtOrdered.push_back(theXConePUPPIJetPhi_XConeCalc->at(xconepuppijetptindpair[ijet].second));
      	theXConePUPPIJetEnergy_XConeCalc_PtOrdered.push_back(theXConePUPPIJetEnergy_XConeCalc->at(xconepuppijetptindpair[ijet].second));
      }
      ...
      int isPastAK4HTCut = 0;
      if( AK4HT > AK4HTCut){npass_AK4HT+=1;isPastAK4HTCut=1;}	
	...
	if(!isMC){
      ...
      if(!(isPastAK4HTCut && isPastMETcut && isPastNJetsCut && isPastJetLeadPtCut && isPastLepPtCut && (isPastElEtaCut || isPastMuEtaCut) && isPastJetSubLeadPtCut)) continue;
      npass_all+=1;
...
*/
   ...
   std::cout<<"Npassed_AK4HT          = "<<npass_AK4HT<<" / "<<nentries<<std::endl;
