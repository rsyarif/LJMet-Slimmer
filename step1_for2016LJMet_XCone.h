...
public :
   ...
   Int_t           NXConeJets;
   Double_t        XConeHT;
   vector<double>  RawXConeJetPt_XConeCalc_PtOrdered;
   vector<double>  RawXConeJetEta_XConeCalc_PtOrdered;
   vector<double>  RawXConeJetPhi_XConeCalc_PtOrdered;
   vector<double>  RawXConeJetEnergy_XConeCalc_PtOrdered;
   vector<double>  RawXConeJetArea_XConeCalc_PtOrdered;
   vector<double>  theXConeJetPt_XConeCalc_PtOrdered;
   vector<double>  theXConeJetEta_XConeCalc_PtOrdered;
   ...
   vector<double>  theXConePUPPIJetEta_XConeCalc_PtOrdered;
   ...
   //XCone -start
   Int_t XConeNumJets_optimal_XConeCalc;
   Int_t XConeNumJets_optimal_puppi_XConeCalc;
   Float_t eventRho_XConeCalc;
   vector<double>  *tau_njettiness_XConeCalc;
   vector<double>  *tau_njettiness_puppi_XConeCalc;
   vector<double>  *tau_njettiness_diff_XConeCalc;
   vector<double>  *tau_njettiness_diff_puppi_XConeCalc;
   vector<double>  *tau_njettiness_div_XConeCalc;
   vector<double>  *tau_njettiness_div_puppi_XConeCalc;
   vector<double>  *tau_njettiness_diffdivComb_XConeCalc;
   vector<double>  *tau_njettiness_diffdivComb_puppi_XConeCalc;
   vector<double>  *RawXConeJetPt_XConeCalc;
   vector<double>  *RawXConeJetEta_XConeCalc;
   vector<double>  *RawXConeJetPhi_XConeCalc;
   vector<double>  *RawXConeJetEnergy_XConeCalc;
   vector<double>  *RawXConeJetArea_XConeCalc;
   ...
   vector<double>  *theXConeJetArea_XConeCalc;
   vector<double>  *theXConePUPPIJetPt_XConeCalc;
   vector<double>  *theXConePUPPIJetEta_XConeCalc;
   vector<double>  *theXConePUPPIJetPhi_XConeCalc;
   vector<double>  *theXConePUPPIJetEnergy_XConeCalc;
   vector<double>  *theXConePUPPIJetArea_XConeCalc;
   //XCone -end
   ...
   TBranch        *b_tau_njettiness_puppi_XConeCalc;
   TBranch        *b_tau_njettiness_diff_XConeCalc;
   TBranch        *b_tau_njettiness_diff_puppi_XConeCalc;
   TBranch        *b_tau_njettiness_div_XConeCalc;
   TBranch        *b_tau_njettiness_div_puppi_XConeCalc;
   TBranch        *b_tau_njettiness_diffdivComb_XConeCalc;
   TBranch        *b_tau_njettiness_diffdivComb_puppi_XConeCalc;
   TBranch        *b_XConeNumJets_optimal_XConeCalc;
   TBranch        *b_XConeNumJets_optimal_puppi_XConeCalc;
   TBranch        *b_eventRho_XConeCalc;
   TBranch        *b_RawXConeJetPt_XConeCalc;
   TBranch        *b_RawXConeJetEta_XConeCalc;
   TBranch        *b_RawXConeJetPhi_XConeCalc;
   TBranch        *b_RawXConeJetEnergy_XConeCalc;
   TBranch        *b_RawXConeJetArea_XConeCalc;
   ...
   TBranch        *b_theXConeJetArea_XConeCalc;
   TBranch        *b_theXConePUPPIJetPt_XConeCalc;
   TBranch        *b_theXConePUPPIJetEta_XConeCalc;
   TBranch        *b_theXConePUPPIJetPhi_XConeCalc;
   TBranch        *b_theXConePUPPIJetEnergy_XConeCalc;
   TBranch        *b_theXConePUPPIJetArea_XConeCalc;
   //XCone -end
...
void step1::Init(TTree *tree)
{
   ...
   tau_njettiness_puppi_XConeCalc = 0;
   tau_njettiness_diff_XConeCalc = 0;
   tau_njettiness_diff_puppi_XConeCalc = 0;
   tau_njettiness_div_XConeCalc = 0;
   tau_njettiness_div_puppi_XConeCalc = 0;
   tau_njettiness_diffdivComb_XConeCalc = 0;
   tau_njettiness_diffdivComb_puppi_XConeCalc = 0;
   RawXConeJetPt_XConeCalc = 0;
   RawXConeJetEta_XConeCalc = 0;
   RawXConeJetPhi_XConeCalc = 0;
   RawXConeJetEnergy_XConeCalc = 0;
   RawXConeJetArea_XConeCalc = 0;
   theXConeJetPt_XConeCalc = 0;
   theXConeJetEta_XConeCalc = 0;
   theXConeJetPhi_XConeCalc = 0;
   theXConeJetEnergy_XConeCalc = 0;
   theXConeJetArea_XConeCalc = 0;
   theXConePUPPIJetPt_XConeCalc = 0;
   theXConePUPPIJetEta_XConeCalc = 0;
   theXConePUPPIJetPhi_XConeCalc = 0;
   theXConePUPPIJetEnergy_XConeCalc = 0;
   theXConePUPPIJetArea_XConeCalc = 0;
   //XCone -end
   ...
   inputTree->SetBranchAddress("tau_njettiness_puppi_XConeCalc",&tau_njettiness_puppi_XConeCalc,&b_tau_njettiness_puppi_XConeCalc);
   inputTree->SetBranchAddress("tau_njettiness_diff_XConeCalc",&tau_njettiness_diff_XConeCalc,&b_tau_njettiness_diff_XConeCalc);
   inputTree->SetBranchAddress("tau_njettiness_diff_puppi_XConeCalc",&tau_njettiness_diff_puppi_XConeCalc,&b_tau_njettiness_diff_puppi_XConeCalc);
   inputTree->SetBranchAddress("tau_njettiness_div_XConeCalc",&tau_njettiness_div_XConeCalc,&b_tau_njettiness_div_XConeCalc);
   inputTree->SetBranchAddress("tau_njettiness_div_puppi_XConeCalc",&tau_njettiness_div_puppi_XConeCalc,&b_tau_njettiness_div_puppi_XConeCalc);
   inputTree->SetBranchAddress("tau_njettiness_diffdivComb_XConeCalc",&tau_njettiness_diffdivComb_XConeCalc,&b_tau_njettiness_diffdivComb_XConeCalc);
   inputTree->SetBranchAddress("tau_njettiness_diffdivComb_puppi_XConeCalc",&tau_njettiness_diffdivComb_puppi_XConeCalc,&b_tau_njettiness_diffdivComb_puppi_XConeCalc);
   inputTree->SetBranchAddress("XConeNumJets_optimal_XConeCalc",&XConeNumJets_optimal_XConeCalc,&b_XConeNumJets_optimal_XConeCalc);
   inputTree->SetBranchAddress("XConeNumJets_optimal_puppi_XConeCalc",&XConeNumJets_optimal_puppi_XConeCalc,&b_XConeNumJets_optimal_puppi_XConeCalc);
   inputTree->SetBranchAddress("eventRho_XConeCalc",&eventRho_XConeCalc,&b_eventRho_XConeCalc);
   inputTree->SetBranchAddress("RawXConeJetPt_XConeCalc",&RawXConeJetPt_XConeCalc,&b_RawXConeJetPt_XConeCalc);
   inputTree->SetBranchAddress("RawXConeJetEta_XConeCalc",&RawXConeJetEta_XConeCalc,&b_RawXConeJetEta_XConeCalc);
   inputTree->SetBranchAddress("RawXConeJetPhi_XConeCalc",&RawXConeJetPhi_XConeCalc,&b_RawXConeJetPhi_XConeCalc);
   inputTree->SetBranchAddress("RawXConeJetEnergy_XConeCalc",&RawXConeJetEnergy_XConeCalc,&b_RawXConeJetEnergy_XConeCalc);
   inputTree->SetBranchAddress("RawXConeJetArea_XConeCalc",&RawXConeJetArea_XConeCalc,&b_RawXConeJetArea_XConeCalc);
   ...
   inputTree->SetBranchAddress("theXConeJetArea_XConeCalc",&theXConeJetArea_XConeCalc,&b_theXConeJetArea_XConeCalc);
   inputTree->SetBranchAddress("theXConePUPPIJetPt_XConeCalc",&theXConePUPPIJetPt_XConeCalc,&b_theXConePUPPIJetPt_XConeCalc);
   inputTree->SetBranchAddress("theXConePUPPIJetEta_XConeCalc",&theXConePUPPIJetEta_XConeCalc,&b_theXConePUPPIJetEta_XConeCalc);
   inputTree->SetBranchAddress("theXConePUPPIJetPhi_XConeCalc",&theXConePUPPIJetPhi_XConeCalc,&b_theXConePUPPIJetPhi_XConeCalc);
   inputTree->SetBranchAddress("theXConePUPPIJetEnergy_XConeCalc",&theXConePUPPIJetEnergy_XConeCalc,&b_theXConePUPPIJetEnergy_XConeCalc);
   inputTree->SetBranchAddress("theXConePUPPIJetArea_XConeCalc",&theXConePUPPIJetArea_XConeCalc,&b_theXConePUPPIJetArea_XConeCalc);
   //inputTree->SetBranchAddress("",&,&b_);
   //XCone - end
