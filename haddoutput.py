...
for sample in dirList:
    ...
    if len(rootfiles) < nFilesPerHadd:
    	...
    	print "len(rootfiles)", len(rootfiles)
    	print "nFilesPerHadd)", nFilesPerHadd
    	print "len(rootfiles)/nFilesPerHadd)", len(rootfiles)/nFilesPerHadd
    	print "int(len(rootfiles)/nFilesPerHadd)", int(len(rootfiles)/nFilesPerHadd)
    	print "range(int(len(rootfiles)/nFilesPerHadd))", range(int(len(rootfiles)/nFilesPerHadd))
