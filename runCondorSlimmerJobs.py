...
# workDir = 'LJMet80X_1lep_XCone_2018_1_18_rizki' 
# workDir = 'LJMet80X_1lep_XCone_2018_1_26_rizki' #just WJetsToLNu and TT_TuneCUETP8M2T4_v1_13TeV-powheg-pythia8
workDir = 'LJMet80X_1lep_XCone_2018_1_29_rizki' #just WJetsToLNu HT600-800
relbase = '/uscms_data/d3/rsyarif/CERN2018/XConeInTTsearch/CMSSW_8_0_26_patch1/'
inputDir='/eos/uscms/store/user/lpcljm/2016/'+workDir+'/'+shift+'/'

# outputDir='/eos/uscms/store/user/lpcljm/2016/'+workDir+'_step1/'+shift+'/'
# condorDir='/uscms_data/d3/rsyarif/CERN2018/XConeInTTsearch/'+workDir+'_step1/'+shift+'/'
outputDir='/eos/uscms/store/user/lpcljm/2016/'+workDir+'_step1_v2/'+shift+'/' #including maxMlep3XConeJets
condorDir='/uscms_data/d3/rsyarif/CERN2018/XConeInTTsearch/'+workDir+'_step1_v2/'+shift+'/'#including maxMlep3XConeJets
...
#     
#     #Wasnt done (done on 29Jan-2018):
#     'TprimeTprime_M-1100_TuneCUETP8M1_13TeV-madgraph-pythia8',
#     'TprimeTprime_M-1500_TuneCUETP8M1_13TeV-madgraph-pythia8', #MEM FAIL: TprimeTprime_M-1500_TuneCUETP8M1_13TeV-madgraph-pythia8_3.jdl
...
# Transfer_Input_Files = %(RUNDIR)s/makeStep1.C, %(RUNDIR)s/%(POST)s/step1.cc, %(RUNDIR)s/%(POST)s/step1.h, %(RUNDIR)s/%(POST)s/step1_cc.d, %(RUNDIR)s/%(POST)s/step1_cc.so, %(RUNDIR)s/%(POST)s/puppiCorr.root
...
#     
#     #Wasnt done: (Done 29 Jan-2018)
#     'BprimeBprime_M-900_TuneCUETP8M1_13TeV-madgraph-pythia8',
#     'BprimeBprime_M-1700_TuneCUETP8M1_13TeV-madgraph-pythia8', #EMPTY LOG: BprimeBprime_M-1700_TuneCUETP8M1_13TeV-madgraph-pythia8_2.jdl
#     ]
# 
...
#     'WJetsToLNu_HT-2500ToInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8', #done 30Jan-2018
#     'WJetsToLNu_HT-400To600_TuneCUETP8M1_v1_13TeV-madgraphMLM-pythia8', #done 30Jan-2018
#     'WJetsToLNu_HT-400To600_TuneCUETP8M1_ext1_13TeV-madgraphMLM-pythia8',
    'WJetsToLNu_HT-600To800_TuneCUETP8M1_13TeV-madgraphMLM-pythia8', #done 31Jan-2018 
...
#     dirList.append('SingleElectron_RRBCDEFGH')
#     dirList.append('SingleElectron_RRHv3')
#     dirList.append('SingleMuon_RRBCDEF')
#     dirList.append('SingleMuon_RRGH')
#     dirList.append('SingleMuon_RRHv3')
